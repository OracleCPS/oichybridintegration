...
- Click on **Save** button ar the top right corner to save all your work.
...
- Now click on `Approved?` gateway then drage the arrow icon and drop on **End** as shown below.
...
- Drag and drop **customerId** from left pane below 
